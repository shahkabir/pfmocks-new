@extends('layouts.app')
@section('title', 'Create PTE Module Mapping')

@section('content')
<div class="container-fluid mt-4">
    <div class="card shadow-sm" style="max-width:640px">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Map Module → PTE Section</h5>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.pte.modules.store') }}">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="pte_section_id" class="form-select" required>
                        ...
                        @foreach($sections as $s)
                            <option value="{{ $s->id }}" {{ old('pte_section_id') == $s->id ? 'selected' : '' }}>
                                {{ $s->name }} ({{ $s->tag }})
                            </option>
                        @endforeach
                    </select>
